...
#[async_trait(?Send)]
impl CustomFunction for PhextStorage {
...
#[async_trait(?Send)]
impl CustomFunctionMut for PhextStorage {
...
#[async_trait(?Send)]
impl StoreMut for PhextStorage {
